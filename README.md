...
Uma Routine do Claude roda todos os dias às 09:00 (Brasília), busca pesquisas novas, atualiza `data/research/`, roda merge, validação e testes, e faz push. Prompt em `docs/routine-diaria.md`.
